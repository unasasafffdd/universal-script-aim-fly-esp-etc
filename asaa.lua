-- ═══════════════════════════════════════════════════════════════
--   Sakura Edition  ·  Anti-AC Bypass Build (No Silent Aim)
...
makeToggle(pMain, "Hitbox Expander", Cfg.Hitbox.Enabled, function(v) Cfg.Hitbox.Enabled = v; refreshHitboxes() end, 6)
makeToggle(pMain, "SpeedHack", Cfg.SpeedHack.Enabled, function(v) Cfg.SpeedHack.Enabled = v; if not v then stopSpeedHack() end end, 7)
makeToggle(pMain, "GodMode", Cfg.GodMode.Enabled, function(v) Cfg.GodMode.Enabled = v; if not v then stopGodMode() end end, 8)
makeToggle(pMain, "BunnyHop", Cfg.BunnyHop.Enabled, function(v) Cfg.BunnyHop.Enabled = v; refreshBunnyHop() end, 9)
makeToggle(pMain, "BHop Accelerate", Cfg.BunnyHop.Accelerate, function(v) Cfg.BunnyHop.Accelerate = v end, 10)
makeToggle(pMain, "Spinner", Cfg.Spinner.Enabled, function(v) Cfg.Spinner.Enabled = v; if not v then stopSpinner() end end, 11)
makeToggle(pMain, "Fling", Cfg.Fling.Enabled, function(v) Cfg.Fling.Enabled = v end, 12)
makeToggle(pMain, "AntiFling", Cfg.AntiFling.Enabled, function(v) Cfg.AntiFling.Enabled = v; refreshAntiFling() end, 13)
makeToggle(pMain, "HitSound", Cfg.HitSound.Enabled, function(v) Cfg.HitSound.Enabled = v; refreshHitSound() end, 14)
...
makeToggle(pMain, "Fullbright", Cfg.Visuals.Fullbright, function(v) Cfg.Visuals.Fullbright = v; setFullbright(v) end, 18)
makeSection(pMain, "Shader", 19)
...
makeToggle(pAim, "Круг FOV", Cfg.Aimbot.ShowFOV, function(v) Cfg.Aimbot.ShowFOV = v end, 10)
makeSection(pAim, "Wallbang", 11)
makeToggle(pAim, "Сквозь стены", Cfg.Wallbang.Enabled, function(v) Cfg.Wallbang.Enabled = v end, 12)
makeToggle(pAim, "Только тонкие", Cfg.Wallbang.VisibleOnly, function(v) Cfg.Wallbang.VisibleOnly = v end, 13)
...
print("[Sakura] Loaded (no Silent Aim).")
